...
class RentalPropertyDetailSchedule(models.Model):
    ...
    @api.depends("detail_id.rental_id.state")
    def _compute_rental_state(self):
        super(RentalPropertyDetailSchedule, self)._compute_rental_state()

    @api.depends("manual", "invoice_id", "invoice_id.state")
    def _compute_state(self):
        super(RentalPropertyDetailSchedule, self)._compute_state()
